...
<!-- 				<table> -->
<!-- 					<caption>재정보고 관리 검색어(키워드)</caption> -->
<!-- 					<colgroup> -->
...
<!-- 							<td> -->
<!-- 								<input type="text" class="input_text w_100" title="제목입력" placeholder="이름, 아이디, 연락처"> -->
<!-- 							</td> -->
<!-- 						</tr> -->
<!-- 					</tbody> -->
<!-- 				</table> -->
...
<!-- 				<div class="right_a"> -->
<!-- 					<a href="#" class="btn btn_white btn_m"><span>초기화</span></a> -->
<!-- 					<a href="#" class="btn btn_black btn_m"><span>조회</span></a> -->
<!-- 				</div> -->
<!-- 			</div> -->
...
$("[data-btn=btnInsert]").on("click", function() {
	$("form[name=frm_form]").attr("action", "/admin/board/finan/finanInsertForm")
...
$("[data-btn=detailInfo]").on("click", function(){
	...
	$("form[name=frm]").attr("method", "GET")
	$("form[name=frm]").attr("action", "/admin/board/finan/finanDetail");
	$("form[name=frm]").submit();
});
</script>
</body>
