                        ...
                        <tr>
                            ...
                            <td colspan="5">
                                <div class="memo_area w_100">
									<textarea name="" id="ckeditor_write" style="resize: none;" disabled>
...
<script>
    ...
    $("[data-btn=btnUpdate]").on("click", function () {
        $("form[name=frm]").attr("action", "/consult/board/sales/salesUpdateForm");
        $("form[name=frm]").submit();
    ...
    function confirmDelete() {
        $(function () {
            ...
            $.ajax({
                type: "POST"
                , url: "/consult/board/sales/salesDelete"
