...
<div class="admin_wrap">
    ...
    <div class="admin_bottom">
        ...
        <!--content-->
        <div class="content">
            <h2 class="con_tit">영업 현황 관리</h2>
            <h3 class="s_tit">영업 현황 등록</h3>
                ...
                <form name="frm_editor">
                    ...
                    <table>
                        ...
                        <tr>
                            <th scope="row">제목</th>
                            <td>
                                <input type="text" class="input_text w_100" title="제목입력" name="TITLE" maxlength="50">
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">내용</th>
...
<script>
    ...
    $("[data-btn=btnSave]").on("click", function () {
        openPopConfirmAlert("${messageSaveConfirm}", salesInsert);
    });

    // 취소
    $("[data-btn=btnCancel]").on("click", function () {
        openPopConfirmAlert("${messageSaveCancelConfirm}", salesList);
    });
    ...
    function salesInsert() {
        ...
        $("form[name=frm_editor]").ajaxSubmit({
            type: "POST"
            , url: "/consult/board/sales/salesInsert"
            , dataType: "json"
            , success: function (responseData) {
                var data = responseData.resultJson;
                if (data.rCode == "0000") {
                    openPopAlertAction("${messageSaveSuccess}", salesList, null);
                } else {
