...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/static/front/css/admin.css"/>
    <script type="text/javascript" src="/static/front/css/jquery-ui.min.css"></script>
</head>
...
<script>
    function goPage(pageNum) {
        ...
        $("form[name=frm]").attr("action", "/admin/board/confirm/confirmList");
    ...
    $("[data-btn=btnInsert]").on("click", function () {
        $("form[name=frm_form]").attr("action", "/consult/board/confirm/confirmInsertForm");
    ...
    $("[data-btn=detailInfo]").on("click", function () {
        ...
        $("form[name=frm]").attr("method", "GET");
        $("form[name=frm]").attr("action", "/consult/board/confirm/confirmDetail");
        $("form[name=frm]").submit();
    });
