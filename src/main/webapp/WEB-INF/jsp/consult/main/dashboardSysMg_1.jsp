...
<body>
					...
					<div class="board_wrap">
						<ul>
							<li>
								...
								<div class="line_chart w_100">
									<p>지점상담원+심사팀+<br>심사팀 관리자+시스템관리자</p>
							...
							<li>
								<div class="count w_100">
									<em>심사팀관리자</em>
									<p>${boardResult.EVAL_MG_USER_CNT}<span>명</span></p>
								</div>
								<div class="line_chart w_100">
									<p class="per eval_mg_per"><span>%</span></p>
							...
							<li>
								<div class="count w_100">
									<em>시스템 관리자</em>
									<p>${boardResult.SYS_MG_USER_CNT}<span>명</span></p>
								</div>
								<div class="line_chart w_100">
									<p class="per sys_mg_per"><span>%</span></p>
	...
	var EVAL_MG_USER_CNT = ( "${boardResult.EVAL_MG_USER_CNT}" ) || 0;
	var SYS_MG_USER_CNT = ( "${boardResult.SYS_MG_USER_CNT}" ) || 0;
	...
	var EVAL_MG_USER_PER = Math.round( (EVAL_MG_USER_CNT / TOTAL_USER_CNT) * 100 ) || 0;
	var SYS_MG_USER_PER = Math.round( (SYS_MG_USER_CNT / TOTAL_USER_CNT) * 100 ) || 0;

	$(".branch_per").html(BRANCH_USER_PER+"<span>%</span>");
	$(".eval_per").html(EVAL_USER_PER+"<span>%</span>");
	$(".eval_mg_per").html(EVAL_MG_USER_PER+"<span>%</span>");
	$(".sys_mg_per").html(SYS_MG_USER_PER+"<span>%</span>");
		//****************************** 쿼리 결과 ******************************
		...
		setTimeout( () => {
			...
			$('.data04').progressbar({
				value: EVAL_MG_USER_PER,
			})

			$('.data05').progressbar({
				value: SYS_MG_USER_PER,
			})
		}, 500)
