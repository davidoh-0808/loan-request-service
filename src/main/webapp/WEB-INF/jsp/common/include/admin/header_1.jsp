...
<div class="admin_top">
	<div class="top_area">
		<!-- 로고 -->
		<div class="logo">
			<h1><span><img src="/resources/publish/img/h_logo.gif" alt="서민금융진흥원 사업수행기관 현대차미소금융재단"></span></h1>
		</div>
		<!-- // 로고 -->
		<!-- 사용자 -->
		<div class="user">
			<span class="name">${sec_member_name }</span> <a href="#" class="r_box" data-btn=btnLogout><span>Log-Out</span></a>
		</div>
		<!-- //사용자 -->
	</div>
</div>
