...
<div class="admin_main">
	...
	<!-- pop_otp -->
	<div id="pop_otpLogin" style="display: none;">
        <div class="pop_contents">
			<p>OTP로 전송된 6자리 인증 코드를 입력 후 [확인] 버튼을 클릭해주세요.</p>
			<div class="otp_input">
				<strong>인증번호</strong>
				<input type="number" placeholder="OTP 인증번호 입력" class="form_control" id="login_otp_val">
			</div>
        </div>
    </div>
...
<script type="text/javascript">
 $(function () {
    ...
    $("#login_otp_val").keyup(function (key) {
        if (key.keyCode == 13) {
    ...
    function otpCheck(){
    	...
    	if(login_otp_val ==""){	//입력된 인증번호가 없으면..
    		$('#pop_fail').dialog({
        	...
        	$("#login_otp").val(login_otp_val);
    		//console.log("login_otp-=------------------"+login_otp_val);
