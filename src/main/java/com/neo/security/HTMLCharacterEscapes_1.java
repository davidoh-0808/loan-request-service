...
public class
HTMLCharacterEscapes extends CharacterEscapes {
	...
	/**
	 * 여기에서 커스터마이징 가능 이전의 Apache Commons Lang3는 LookupTranslator의 파라미터로 String[][]을
	 * 전달하였으나, 새로운 Apache Commons Text는 파라미터로 Map<CharSequence, CharSequence>를 전달해야
	 * 한다.
	 */	
	private static final String[][] CUSTOM_ESCAPE = {
	    {"(", "&#40;"}, // " (
	};
